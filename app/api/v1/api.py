...
from app.api.v1 import auth, measurements, products, admin, categories, user, cart, wishlist
...
api_router.include_router(cart.router, prefix="/api/v1")
api_router.include_router(wishlist.router, prefix="/api/v1")
